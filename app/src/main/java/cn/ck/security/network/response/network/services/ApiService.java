package cn.ck.security.network.response.network.services;
...
import cn.ck.security.network.response.network.response.ApiResponse;
...
public interface ApiService {
    ...
    Call<ApiResponse<List<Car>>> getUnPassedCars(@Path("offset") String start,
                                                 @Path("limit") String offset);
